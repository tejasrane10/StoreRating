...
export function StoreIcon({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function ChevronIcon({ size = 16, color = 'currentColor' }) {
  return (
...
export function getMenuIcon(key, size, color) {
  const map = {
    dashboard: <DashboardIcon size={size} color={color} />,
    store:     <StoreIcon     size={size} color={color} />,
    users:     <UsersIcon     size={size} color={color} />,
    star:      <StarIcon      size={size} color={color} />,
